    ...
    <div className="flex min-h-screen items-center justify-center bg-zinc-950 p-6">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-bold text-white tracking-tight">Create WealthOS Account</h1>
          <p className="text-xs text-zinc-400 mt-1">Get started with institutional portfolio management</p>
        </div>

        {/* Card */}
        <div className="rounded-2xl border border-zinc-800/90 bg-zinc-900/70 p-7 shadow-2xl backdrop-blur-xl">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                />
                {errors.firstName && <p className="mt-1 text-xs text-rose-400 font-medium">{errors.firstName.message}</p>}
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-zinc-800 bg-zinc-950/60 px-3.5 py-2.5 text-sm text-zinc-100 placeholder-zinc-500 transition-colors focus:border-blue-500 focus:bg-zinc-950 focus:outline-none focus:ring-1 focus:ring-blue-500"
                />
                {errors.lastName && <p className="mt-1 text-xs text-rose-400 font-medium">{errors.lastName.message}</p>}
              </div>
            </div>
